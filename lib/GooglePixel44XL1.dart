...
// background:
          ...
          Pinned.fromPins(
            Pin(size: 122.0, middle: 0.3621),
            Pin(size: 33.0, middle: 0.6569),
            child: Text(
              'Plumber',
              style: TextStyle(
                fontFamily: 'Roboto',
          ...
          Pinned.fromPins(
            Pin(size: 50.0, start: 41.0),
            Pin(size: 50.0, middle: 0.523),
            child:
                // Adobe XD layer: 'shovel' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            Pin(size: 50.0, start: 41.0),
            Pin(size: 50.0, middle: 0.7948),
            child:
                // Adobe XD layer: 'carpenter' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            Pin(size: 50.0, start: 41.0),
            Pin(size: 50.0, middle: 0.6576),
            child:
                // Adobe XD layer: 'plumber' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Pinned.fromPins(
            ...
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 37.0, start: 58.0),
                  Pin(size: 37.0, middle: 0.7568),
                  child:
                ...
                Pinned.fromPins(
                  Pin(size: 255.0, middle: 0.3978),
                  Pin(size: 26.0, middle: 0.7412),
                  child: Text(
          ...
          Pinned.fromPins(
            ...
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 48.0, middle: 0.5294),
                  Pin(size: 20.0, middle: 0.5175),
                  child: Transform.rotate(
                    angle: 0.0175,
                    child: Text(
                      '1000+',
